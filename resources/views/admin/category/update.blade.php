...
@section('title', 'update category::{{$data->title}})
                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="title">
                                <h4>update category touristic:{{$data->title}}</h4>
                            </div>
                            ...
                            <div class="pd-20 card-box mb-30">
                                ...
                                <form action="/admin catecory/update/{{$data->title}}" method="post">
                                    @csrf
...
{{--                                        <input class="form-control" value="{{$data->title}}" type="tel">--}}

                                        <div class="form-group row">
                                            <label class="col-sm-3 col-form-label">status</label>
                                            <div class="col-sm-9">
                                                <select class="form-control">
                                                    <option> selected {{$data->status}} True</option>
                                                    <option>false</option>
