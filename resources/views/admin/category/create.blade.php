...
{{--                </a>--}}
{{--            </li>--}}
{{--            <div class="ps__rail-x" style="left: 0px; bottom: -309px;">--}}
{{--                <div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div>--}}
{{--            </div>--}}
{{--            <div class="ps__rail-y" style="top: 309px; height: 446px; right: 4px;">--}}
{{--                <div class="ps__thumb-y" tabindex="0" style="top: 139px; height: 201px;"></div>--}}
{{--            </div>--}}
{{--        </ul>--}}
{{--    </aside>--}}
{{--    <!-- / Menu -->--}}
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            ...
                            <div class="pd-20 card-box mb-30">
                                ...
                                <form action="/admin catecory/store" method="post">
                                    @csrf
